...
from models import steganogan_encoder_basic_model, steganogan_decoder_basic_model
...
class KerasSteganoGAN(keras.Model):
  def __init__(self, encoder=None, decoder=None, image_shape=(None, None, 3), data_depth=1, model_path=None, **kwargs):
    ...
    self.encoder = encoder or steganogan_encoder_basic_model(self.height, self.width, self.channels, self.data_depth)
    self.decoder = decoder or steganogan_decoder_basic_model(self.height, self.width, self.channels, self.data_depth)
